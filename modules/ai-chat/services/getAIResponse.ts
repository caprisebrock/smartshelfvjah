// COPY THIS ENTIRE FILE FROM: lib/getAIResponse.ts
// Move the complete contents of lib/getAIResponse.ts into this file 
...
export async function getAIResponse(
  ...
  // Early return if sessionId is provided but invalid
  if (sessionId !== undefined && (!sessionId || typeof sessionId !== 'string')) {
    console.warn('getAIResponse: invalid sessionId provided', sessionId);
    return { 
      aiResponse: 'Internal error: invalid session'
    };
  }
