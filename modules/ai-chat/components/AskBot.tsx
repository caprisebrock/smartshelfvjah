// COPY THIS ENTIRE FILE FROM: components/AskBot.tsx
// Move the complete contents of components/AskBot.tsx into this file 
...
export default function AskBot({ onSendMessage, isLoading }: AskBotProps) {
